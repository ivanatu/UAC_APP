  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: Theme.of(context).colorScheme.primary.withValues(alpha: 0.31),
          width: 0.4,
        ),
      ),
      child: Padding(
              ...
              TextSpan(
                children: [
                  TextSpan(
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.titleMedium!.apply(fontWeightDelta: 4),
                  ),
                  TextSpan(
                    text:
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.bodyMedium!.apply(color: Colors.grey.shade700),
                  ),
                ],
              ),
            ),
