...
class _SymptomCardGridState extends State<SymptomCardGrid> {
  ...
  final List<Map<String, String>> symptoms = const [
    ...
    {
      "symptom": "Headache",
      "desc": "A persistent or severe headache.",
      "imgPath": "assets/symptoms/headache.png",
    },
    {
      "symptom": "Fatigue",
      "desc": "Extreme tiredness or lack of energy.",
      "imgPath": "assets/symptoms/headache.png",
    },
    {
      "symptom": "Swollen lymph nodes",
      "desc": "Swollen glands in the neck, armpits, or groin.",
      "imgPath": "assets/symptoms/high_fever.png",
    },
    {
      "symptom": "Rash",
      "desc": "Skin rash or bumps that may be itchy.",
      "imgPath": "assets/symptoms/sore_throat.png",
    },
  ];
